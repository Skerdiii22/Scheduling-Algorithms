...
private DefaultTableModel model;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("First Come First Serve Algorithm");
    ...
    if (!rows.isEmpty()) {
        FirstComeFirstServe fcfs = new FirstComeFirstServe(rows);
        fcfs.process();
        ...
        for (int i = 0; i < rows.size(); i++) {
            ...
            double avgTAT = fcfs.getAverageTurnAroundTime();
        double avgWT =   fcfs.getAverageWaitingTime();
