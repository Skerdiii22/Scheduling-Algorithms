...
private DefaultTableModel model;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Shortest Remaining Time First Algorithm");
    ...
    if (!rows.isEmpty()) {
        ShortestRemainingTime srt = new ShortestRemainingTime(rows);
        srt.process();
        ...
        for (int i = 0; i < rows.size(); i++) {
            ...
            double avgTAT = srt.getAverageTurnAroundTime();
        double avgWT =   srt.getAverageWaitingTime();
    ...
    if (!rows.isEmpty()) {
        ...
        List<Event> timeline = srt.getTimeline();
