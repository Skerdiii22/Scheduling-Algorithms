...
private DefaultTableModel model;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Priority Preemptive Algorithm");
    ...
    if (!rows.isEmpty()) {
        PriorityPreemptive pp = new PriorityPreemptive(rows);
        pp.process();
        ...
        for (int i = 0; i < rows.size(); i++) {
            ...
            double avgTAT = pp.getAverageTurnAroundTime();
        double avgWT =   pp.getAverageWaitingTime();
    ...
    if (!rows.isEmpty()) {
        ...
        List<Event> timeline = pp.getTimeline();
