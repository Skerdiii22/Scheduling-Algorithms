...
private DefaultTableModel model;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Shortest Job First Algorithm");
    ...
    if (!rows.isEmpty()) {
        ShortestJobFirst sjf = new ShortestJobFirst(rows);
        sjf.process();
        ...
        for (int i = 0; i < rows.size(); i++) {
            ...
            double avgTAT = sjf.getAverageTurnAroundTime();
        double avgWT =   sjf.getAverageWaitingTime();
